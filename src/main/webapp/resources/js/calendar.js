...
function addElements (query, id){
    ...
    for(var i = 0; i< allOfDays.length; i++){
        if(i === 6 || i === 13 || i === 20 || i === 27 || i === 34){
            ...
            allOfDays[i].outerHTML += '<div class="day-details"><div id="input-arrow"></div><a href="/news?newsdate="+i"></a> </div>'
        }
    }
    document.getElementById(id).innerHTML += '<div class="day-details"><div id="input-arrow"></div><a href="/news?newsdate="+i"></a><div style="clear:both"></div>';
}
